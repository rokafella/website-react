/* image-slot web component — user-fillable photo placeholder
   Slots persist dropped images via a .image-slots.state.json sidecar
   when running inside the omelette design runtime. On the live website,
   placeholders are shown and drag-to-fill works for the session only. */
